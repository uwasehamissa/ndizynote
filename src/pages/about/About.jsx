...
const MicIcon = () => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="currentColor" className="text-pink-400">
    ...
    <path d="M19 10V12C19 15.87 15.87 19 12 19C8.13 19 5 15.87 5 12V10" stroke="currentColor" strokeWidth="2" fill="none"/>
...
const VolumeUpIcon = () => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="currentColor" className="text-blue-400">
    ...
    <path d="M16 9C17.66 9 19 10.34 19 12C19 13.66 17.66 15 16 15" stroke="currentColor" strokeWidth="2" fill="none"/>
    <path d="M16 5C19.31 5 22 7.69 22 12C22 16.31 19.31 19 16 19" stroke="currentColor" strokeWidth="2" fill="none"/>
  </svg>
);
...
export const About = () => {
  ...
  const teachingServices = [
    {
      icon: <PianoIcon />,
      title: "Piano Lessons",
      description: "Comprehensive piano training from classical to contemporary styles",
      levels: ["Beginner", "Intermediate", "Advanced"],
      features: ["Sight reading", "Music theory", "Performance techniques", "Improvisation"]
    },
    {
      icon: <GuitarIcon />,
      title: "Guitar Training",
      description: "Acoustic, electric, and bass guitar mastery across all genres",
      levels: ["Beginner", "Intermediate", "Advanced"],
      features: ["Chord progressions", "Fingerstyle", "Lead techniques", "Music theory"]
    },
    {
      icon: <ViolinIcon />,
      ...
      levels: ["Beginner", "Intermediate", "Advanced"],
      features: ["Bow techniques", "Fingering", "Orchestral training", "Solo performance"]
    },
    {
      icon: <DrumSetIcon />,
      ...
      levels: ["Beginner", "Intermediate", "Advanced"],
      features: ["Rudiments", "Groove development", "Drum notation", "Live performance"]
    }
  ];
  ...
  const vocalServices = [
    {
      ...
      techniques: ["Breath control", "Vocal range expansion", "Pitch perfection", "Tone quality"],
      benefits: ["Increased range", "Better control", "Reduced strain", "Professional sound"]
    },
    {
      icon: <RecordVoiceOver className="text-4xl text-cyan-400" />,
      title: "Performance Training",
      description: "Stage presence and live performance mastery",
      techniques: ["Stage movement", "Audience engagement", "Microphone technique", "Overcoming stage fright"],
      benefits: ["Confidence building", "Professional presence", "Engaging performances", "Career readiness"]
    },
    {
      icon: <GraphicEq className="text-4xl text-yellow-400" />,
      title: "Studio Recording",
      description: "Professional studio vocal recording and production",
      techniques: ["Microphone selection", "Studio etiquette", "Vocal production", "Mixing techniques"],
      benefits: ["Studio experience", "Professional recordings", "Industry knowledge", "Portfolio development"]
    },
    {
      icon: <TheaterComedy className="text-4xl text-red-400" />,
      title: "Musical Theater",
      description: "Specialized training for musical theater and acting through song",
      techniques: ["Character development", "Emotional expression", "Storytelling", "Dance integration"],
      benefits: ["Audition preparation", "Character work", "Broadway techniques", "Triple threat development"]
    }
  ];
  ...
  // Stats
  const stats = [
    { number: "15+", label: "Years Experience", icon: <TrendingUp className="text-2xl" /> },
    { number: "500+", label: "Students Trained", icon: <Groups className="text-2xl" /> },
    { number: "98%", label: "Success Rate", icon: <Star className="text-2xl" /> },
    { number: "50+", label: "Performances Yearly", icon: <LibraryMusic className="text-2xl" /> }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 pt-20">
      ...
      <section className="relative py-16 sm:py-20 lg:py-24 bg-gradient-to-r from-purple-600 to-blue-600 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              Where <span className="text-cyan-300">Technical Precision</span> Meets <span className="text-pink-300">Artistic Expression</span>
            </motion.h1>
            <motion.p 
            ...
            >
              A transformative learning experience that cultivates exceptional musicians through innovative pedagogy, 
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              To cultivate exceptional musicians through innovative pedagogy, master-level instruction, 
              and a performance-driven curriculum that transcends traditional music education.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {missionFeatures.map((feature, index) => (
              ...
              >
                <div className={`w-12 h-12 bg-gradient-to-r ${feature.gradient} rounded-xl flex items-center justify-center text-white mb-4`}>
                  {feature.icon}
                </div>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-purple-50 to-blue-50">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
              Comprehensive <span className="text-purple-600">Music Education</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From foundational techniques to advanced performance skills, our curriculum is designed 
              to nurture complete musicianship across all instruments.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {teachingServices.map((service, index) => (
              ...
              >
                ...
                <div className="mb-4">
                  <h4 className="font-semibold text-gray-800 mb-2">Skill Levels:</h4>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
              Professional <span className="text-pink-600">Vocal</span> Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Transform your voice with our comprehensive vocal training programs, 
              designed for singers of all levels and genres.
            </p>
          </motion.div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {service.techniques.map((tech, techIndex) => (
                        <li key={techIndex} className="flex items-center gap-2 text-gray-600 text-sm">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {service.benefits.map((benefit, benefitIndex) => (
                        <li key={benefitIndex} className="flex items-center gap-2 text-gray-600 text-sm">
          ...
          >
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-800 text-center mb-8">
              Specialized <span className="text-purple-600">Development Programs</span>
            </h3>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join our community of passionate musicians and experience the NdziNote difference. 
              Where technical mastery meets artistic freedom in an inspiring learning environment.
            </p>
