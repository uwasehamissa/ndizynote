...
//   return (
//     <>
//       <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl pt-4">
//         {/* Hero Section */}
...
//                 Comprehensive{" "}
//                 <span className="text-purple-600">Music Education</span>
//               </h2>
...
//                 Specialized{" "}
//                 <span className="text-purple-600">Development Programs</span>
//               </h3>
...
export const About = () => {
  ...
  useEffect(() => {
    const fetchStudentsData = async () => {
      try {
        ...
        const response = await fetch('https://ndizmusicprojectbackend.onrender.com/api/users');
        ...
        const studentCount = data.totalStudents || data.count || data.studentsTrained || 500;
  ...
  const stats = [
    ...
    {
      number: loading ? "..." : error ? "N/A" : `${studentsTrained.toLocaleString()}+`, // NEW: API data
      label: "Students Trained",
      icon: <Groups className="text-2xl" />,
    },
    {
                ...
                {stats.map((stat, index) => (
                  ...
                  >
                    ...
                    {stat.label === "Students Trained" && (
                      <div className="text-xs text-white/60 mt-1">
                        {loading ? "Loading..." : error ? "Offline" : "Live data"}
                      </div>
                    )}
                  </motion.div>
                ))}
