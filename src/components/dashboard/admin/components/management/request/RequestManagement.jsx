...
//   try {
//     const { data } = await api.post("/api/bookings", bookingForm);

//     // Normalize response (backend may return data in different keys)
//     const newRequest =
//       data?.data || data?.booking || data;
...
//             {/* Debug Info - Remove in production */}
//             <div className="mb-4 text-xs text-gray-100">
//               Showing {currentRequests.length} of {filteredRequests.length} filtered requests
